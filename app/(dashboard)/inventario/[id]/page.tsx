...
export default async function ProductDetailPage(props: { params: Promise<{ id: string }> }) {
  ...
  const formattedUnitCost = new Intl.NumberFormat('es-CO', { style: 'currency', currency: 'COP', minimumFractionDigits: 0, maximumFractionDigits: 2 }).format(unitCost);
            ...
            <div className="mt-8">
              <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 flex items-start gap-3">
                ...
                <p className="text-body-sm text-on-surface-variant">
                  ...
                  El valor total en stock para este producto es de <strong className="text-on-surface">{new Intl.NumberFormat('es-CO', { style: 'currency', currency: 'COP', minimumFractionDigits: 0, maximumFractionDigits: 2 }).format(unitCost * product.stock)}</strong>.
                </p>
              </div>
            </div>
          </div>
