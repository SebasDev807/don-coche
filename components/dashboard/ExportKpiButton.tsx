...
export function ExportKpiButton({ endpoint, showDateFilters }: ExportKpiButtonProps) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute left-0 top-full mt-2 bg-surface-container-lowest border border-outline-variant rounded-xl shadow-lg p-4 z-50 w-72">
          <h4 className="font-bold text-sm text-on-surface mb-3">Exportar Rentabilidad</h4>
