...
export function CreateProductForm() {
  ...
  const { formattedCostWithIva, formattedSellingPrice } = useSellingPrice(unitCostValue as any, profitPercentageValue as number, ivaValue as number, hasIvaValue, autoRoundValue);
  ...
  const onSubmit = async (data: CreateProductFormValues) => {
    ...
    Object.entries(data).forEach(([key, value]) => {
      if (isInsumos && (key === 'profitPercentage' || key === 'iva' || key === 'hasIva' || key === 'autoRound')) {
        return;
      }
