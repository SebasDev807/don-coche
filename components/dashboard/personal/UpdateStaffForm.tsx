...
import { updateUserSchema, UpdateUserFormValues } from '@/validation';
import { updateStaffUser } from '@/actions/personal';
...
export function UpdateStaffForm({ user }: UpdateStaffFormProps) {
